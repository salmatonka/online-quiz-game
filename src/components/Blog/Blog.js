...
const Blog = () => {
    return (
        <div>
          ...
          text-2xl ' > Question:3<span>
            <Link
          to='/'
className='px-4 py-1 rounded-lg shadow-xl bg-gray-100
  text-red-400'>
Back to homepage
</Link></span> 

</h1>
            <div className='border-gray-300 rounded-lg shadow-xl   mx-10 my-8 py-4 px-5 bg-sky-200'>


                <h1 className='font-bold pb-2 '>1. what is the purpose of react ?</h1>
...
<div  className='border-gray-300 rounded-lg shadow-xl   mx-10 my-8 py-5 px-5 bg-sky-200'>
    <h1 className='font-bold pb-2'>2. what is usehref hook ?</h1>
...
<div className='border-gray-300 rounded-lg shadow-xl   mx-10 my-8 py-5 px-5 bg-sky-200'>
    <h1 className='font-bold pb-2'>3. how does context api work ?</h1>
